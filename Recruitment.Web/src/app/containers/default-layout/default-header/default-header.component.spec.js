...
var icon_subset_1 = require("../../../icons/icon-subset");
...
describe('DefaultHeaderComponent', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.TestBed.configureTestingModule({
                        ...
                        imports: [angular_1.GridModule, angular_1.HeaderModule, angular_1.NavModule, angular_1.BadgeModule, angular_1.AvatarModule, angular_1.DropdownModule, angular_1.BreadcrumbModule, testing_2.RouterTestingModule, angular_1.SidebarModule],
                        providers: [icons_angular_1.IconSetService]
                    })
                        .compileComponents()];
                case 1:
                    _a.sent();
    ...
    beforeEach(function () {
        iconSetService = testing_1.TestBed.inject(icons_angular_1.IconSetService);
        iconSetService.icons = __assign({}, icon_subset_1.iconSubset);
