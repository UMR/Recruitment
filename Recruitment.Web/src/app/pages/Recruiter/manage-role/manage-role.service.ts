...
export class ManageRoleService {
    ...
    deleteRole(deleteUserId: any, updatedUserId: any): Observable<HttpResponse<any>> {
        const deleteRecruiterURI = `${resourceServerUrl}/api/v1/ManageRole/DeleteRole/`;
