...
public class SpecialWordService:ISpecialWordService
{
    ...
    public SpecialWordService(IMapper mapper, ICurrentUserService currentUserService, IDateTimeService dateTime, ISpecialWordRepository specialWordRepository)
    {
        _mapper = mapper;
